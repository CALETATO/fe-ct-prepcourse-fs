...
// return  array.map((i)=>i+1) recibe un callback --> solucion 2
// var array nuevo = array.map(function (numero){return numero = numero + 1}); return array nuevo; ---> solucion 3
...
function dePalabrasAFrase(palabras) {
   ...
   // return string --> solucion 1
var concatenadas= palabras.reduce(function(acc,palabra){
   return acc + ' ' + palabra;
})
return concatenadas;
}
...
function arrayContiene(array, elemento) {
  ...
  // })
//   return array.includes(elemento)--> solucion 1
//return contiene
for (item of array){
   if (item === elemento){ 
   return true;
...
// }   var totalsuma = arrayOfNums.reduce(function sumar(acc,num){
//    return acc + num;); ---> reduce con la funcion integrada
return totalsuma;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   var promedio = totalsuma/totalelementos;
return promedio;
}
